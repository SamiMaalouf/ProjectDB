        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.lessons.index') }}">Lessons</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.tests.index') }}">Tests</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('frontend.faq-categories.index') }}">FAQ</a>
                    </li>
                </ul>
